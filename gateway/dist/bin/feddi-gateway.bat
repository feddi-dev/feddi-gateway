...
@rem
@rem  Finds Java, validates version, and starts the gateway with tuned defaults.
@rem
@rem  Environment variables:
@rem    GATEWAY_JAVA_HOME - Java home for the gateway (takes priority over JAVA_HOME)
...
if defined GATEWAY_JAVA_HOME (
    set "JAVA_EXE=%GATEWAY_JAVA_HOME%\bin\java.exe"
...
echo.
echo   Set JAVA_HOME or GATEWAY_JAVA_HOME, or add java to your PATH.
...
if %JAVA_MAJOR% LSS 25 (
    ...
    echo   Java:  %JAVA_EXE%
    echo.
    echo   Set GATEWAY_JAVA_HOME or JAVA_HOME to a Java 25+ installation.
    echo.
    exit /b 1
)
