...
When an incident does occur, it is important to report it promptly. To report a possible violation, email `hello@feddi.dev` with the subject line `feddi Gateway Code of Conduct Report`.
...
The remedies and repairs outlined below are guidelines used by project maintainers when responding to violations. Maintainers may adapt the response to the circumstances of the incident and the safety needs of the community.
